...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Tinggalkan Komentar</h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Simpan nama dan email saya di browser ini untuk komentar selanjutnya.</label>
        </div>
      </div>
      {error && <p className="text-xs text-red-500">Pastikan semua kolom sudah terisi</p>}
      <div className="mt-8">
        ...
        {showSuccessMessage && <span className="text-xl float-right font-semibold mt-3 text-green-500">Komentar telah dikirim untuk ditinjau</span>}
      </div>
    </div>
  );
};
